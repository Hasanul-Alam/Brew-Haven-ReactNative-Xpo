      ...
      <View className="w-[85%] mx-auto">
        ...
        <View className="my-5">
          <View className="flex-row justify-between items-center w-full mx-auto">
            <View>
              <View className="bg-[#21262E] p-1 rounded-lg">
                <Ionicons name="chevron-back" color={"#ded9d9"} size={25} />
              </View>
            </View>
            <View>
              <Text className="text-2xl text-white font-semibold">Payment</Text>
            </View>
          ...
          <View className="flex-row justify-between bg-[#262B33] px-3 rounded-full items-center py-3 mt-8">
            <View className="flex-row gap-2">
              <View className="w-[25px] h-[20px]">
                <Image
                  className="w-full h-full"
                  source={{ uri: "https://i.ibb.co.com/CnwbTVg/Wallet.png" }}
                />
              </View>
          ...
          <View className="flex-row justify-between bg-[#262B33] px-3 rounded-full items-center py-3 mt-3">
            <View className="flex-row gap-2">
              <View className="w-[25px] h-[20px]">
                <Image
                  className="w-full h-full"
                  source={{ uri: "https://i.ibb.co.com/Tm0vbrH/Google-Play.png" }}
                />
              </View>
            ...
            <View className="flex-row gap-2 items-center">
              <View className="w-[25px] h-[20px]">
                <Image
                  className="w-full h-full"
                  resizeMode="cover"
                  source={{ uri: "https://i.ibb.co.com/hHkt9F7/Amazon.png" }}
                />
              </View>
